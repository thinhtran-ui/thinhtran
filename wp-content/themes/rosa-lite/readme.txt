...
= 1.0.7 =
* Improve compatibility with WordPress 5.6.
* Fixed overflow caused by long site title on mobiles.

= 1.0.6 =
* Fixed some visual inconsistencies.
* Removed unused selectors from Customify config file.
...
= 1.0.1 =
* Styling enhancements to make sure that keyboard navigation is working properly (accessibility).
